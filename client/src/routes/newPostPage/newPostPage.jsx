        ...
        <div className="wrapper">
          <form onSubmit={handleSubmit}>
            ...
            <div className="item description">
              ...
              <ReactQuill theme="snow" required onChange={setValue} value={value} />
            </div>
            <div className="item">
            ...
            <div className="item">
              ...
              <input min={0} required id="size" name="size" type="number" />
            </div>
            <div className="item">
              <label htmlFor="school">School</label>
              <input min={0} required id="school" name="school" type="number" />
            </div>
            <div className="item">
              <label htmlFor="bus">bus</label>
              <input min={0} required id="bus" name="bus" type="number" />
            </div>
            <div className="item">
              <label htmlFor="restaurant">Restaurant</label>
              <input min={0} required id="restaurant" name="restaurant" type="number" />
            </div>
